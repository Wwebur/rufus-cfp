...
const PrivacyPageTemplate = ({ title, subtitle, meta_title, meta_description }) => {
  return (
    <div>
      <Helmet>
      ...
      <section className='section'>
        <div className='container content'>
          ...
          <div className='column is-three-fifths is-offset-one-fifth'>
            ...
            <p>Thank you for choosing to be part of our community at Critical Friend Partnership (“Company”, “we”, “us”, or “our”). We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about this privacy notice, or our practices with regards to your personal information, please contact us at richard.pitt@criticalfriendpartnership.co.uk.</p>

            <p>When you visit our website https://criticalfriendpartnership.co.uk/ (the "Website"), and more generally, use any of our services (the "Services", which include the Website), we appreciate that you are trusting us with your personal information. We take your privacy very seriously. In this privacy notice, we seek to explain to you in the clearest way possible what information we collect, how we use it and what rights you have in relation to it. We hope you take some time to read through it carefully, as it is important. If there are any terms in this privacy notice that you do not agree with, please discontinue use of our Services immediately.</p>
            ...
            <p>Personal Information Provided by You. We collect names; phone numbers; email addresses; and other similar information.</p>
            ...
            <ul>
              <li>Retargeting Platforms: Perfect Audience</li>
            ...
            <p>If you have questions or comments about this notice, you may email us at richard.pitt@criticalfriendpartnership.co.uk</p>
            
            <h2>HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h2>

            <p>Based on the applicable laws of your country, you may have the right to request access to the personal information we collect from you, change that information, or delete it in some circumstances. To request to review, update, or delete your personal information, please contact the email above. We will respond to your request within 30 days.</p>
