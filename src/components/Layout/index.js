...
class Layout extends React.Component {
  ...
  render() {
    ...
    // Only load client component after mount
    const ClientNavBar = mounted && isBrowser 
      ? React.lazy(() => import("./ClientNavBar"))
      : null;
      ...
      <div id="layout-wrapper">
        <Helmet>
          ...
          <meta
            ...
            content="Critical Friend Partnership is able to operate as both a Non-Exec to your business and as an exclusive consultancy service."
          />
        </Helmet>

        {mounted && ClientNavBar ? (
          <React.Suspense fallback={
            <>
              <NavBar isActive={false} toggleNavbar={() => {}} />
